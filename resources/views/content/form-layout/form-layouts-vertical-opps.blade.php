...
<style type="text/css">
    ...
    />
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Opportunities/</span> Add New Opportunity</h4>

<!-- Basic Layout -->
<div class="card container" style="width:80%"> 
  <form action="{{@route('opp.add')}}" method="POST" enctype="multipart/form-data">
                @csrf 
  ...
  @if($lead)
                  ...
                  <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge ">
                          ...
                          <input type="text"  name="name" value="@if($lead){{$lead->name}}@endif" class="form-control @error('name') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3"> @if($lead){{$lead->description}}@endif</textarea>
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" name="size" min="0" value="@if($lead){{$lead->size}}@endif" id="size_input" class="form-control wb @error('size') is-invalid @enderror price_number" placeholder="" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        </div>
                        @error('size')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-company2" class="input-group-text">SAR</span>
                          <input type="text" name="cost" min="0" onkeyup="costError()"  id="cost_input" class="form-control wb @error('cost') is-invalid @enderror price_number " placeholder="" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        </div>
                      ...
                      <!-- <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="number" name="selling_price" min="0" id="basic-icon-default-company" class="form-control wb @error('selling_price') is-invalid @enderror " placeholder="UBMRELLA.SA" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        </div>
                        @error('selling_price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="date" name="closing_date" value="@if($lead){{$lead->closing_date}}@endif" id="basic-icon-default-email" class="form-control @error('closing_date') is-invalid @enderror" placeholder="" aria-label="john.doe" aria-describedby="basic-icon-default-email2" />
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select @error('clients') is-invalid @enderror" id="clients_select" name="clients" onchange="getContactsFromClient()" id="exampleFormControlSelect1" aria-label="Default select example">
                          ...
                          <option value="{{$client->id}}" @if($lead && $lead->client == $client->id ) selected @endif>{{$client->name}} </option>
                            @endforeach
                        </select>
                        @error('clients') 
                            <span class="text-danger">{{ $message }}</span>
                     ...
                     <div class="mb-3" id="contact_div" style="@if($lead)display:block @else display:none @endif">
                        ...
                        <select class="form-select content_container @error('contacts') is-invalid @enderror " name="contacts" id="exampleFormControlSelect1" aria-label="Default select example">
                          ...
                          <option value="{{$contact->id}}" @if($lead && $lead->contact ) selected @endif>{{$contact->first_name.$contact->last_name}} </option>
                            @endforeach
                        </select>
                        @error('contacts') 
                            <span class="text-danger">{{ $message }}</span>
                  ...
                  <div  >
                      <input type="submit" id="submit_button" onclick="replace_country()" class="btn btn-info btn-block " value="Assign New"/>  
</div>
