...
@section('title', 'Lead Request Info')
...
<style type="text/css">
    ...
    />
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Requests/</span>Lead Request Info</h4>

<!-- Basic Layout -->
<div class="card container" style="width:80%"> 
  <form action="{{@route('lead.request.accept' , $lead->id)}}" method="GET" enctype="multipart/form-data">
                @csrf 
                  ...
                  <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge ">
                          ...
                          <input type="text"  name="name" value="{{$lead->name}}" class="form-control @error('name') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" disabled />
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3" disabled>{{$lead->description}}</textarea>
                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="basic-icon-default-company">Size  *</label>
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-company2" class="input-group-text">SAR</span>
                          <input type="number" name="size" min="0" id="basic-icon-default-company" disabled value="{{$lead->size}}" class="form-control wb @error('size') is-invalid @enderror " placeholder="" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        </div>
                        @error('size')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="date" name="closing_date" id="basic-icon-default-email" disabled value="{{date('Y-m-d',strtotime($lead->closing_date))}}" class="form-control @error('closing_date') is-invalid @enderror" placeholder="" aria-label="john.doe" aria-describedby="basic-icon-default-email2" />
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select @error('clients') is-invalid @enderror" disabled id="clients_select" name="client" onchange="getContactsFromClient()" id="exampleFormControlSelect1" aria-label="Default select example">
                     ...
                     <div class="mb-3">
                        ...
                        <select disabled class="form-select content_container @error('contacts') is-invalid @enderror " name="contact" id="exampleFormControlSelect1" aria-label="Default select example">
                      ...
                      <!-- <div class="mb-3">
                        ...
                        <select disabled class="form-select" name="status" id="exampleFormControlSelect1" aria-label="Default select example">
                     ...
                     <div class="mb-3">
                        ...
                        <select disabled class="form-select" name="source" id="myselect" onchange="getSourceValue()" aria-label="Default select example">
                     ...
                     <div class="mb-3">
                        ...
                        <select disabled class="form-select @error('sales') is-invalid @enderror"  name="sales_user" id="exampleFormControlSelect1" aria-label="Default select example">
                     ...
                     <div class="mb-3" style="display:none" id="source_other">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input disabled type="text"  id="source_other_input" class="form-control phone-mask " placeholder="for ex : sales or any" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
                        </div>
                  ...
                  <div  >
                      <input type="submit"  class="btn btn-info btn-block " value="Accept Request"/>  
                      <a type="button" href="{{route('lead.request.reject' , $lead->id)}}"   class="btn btn-danger btn-block " >Reject Request</a>  
