...
@section('title', ' View Opportunity Info')
...
<style type="text/css">
    ...
    />
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Opportunities / </span>View Opportunity Info</h4>

<!-- Basic Layout -->
<div class="card container" style="width:80%"> 
  <form action="{{@route('opp.update' , $opp->id)}}" method="POST" enctype="multipart/form-data" id="target">
                @csrf 
                  ...
                  <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge ">
                          ...
                          <input type="text" disabled   value="{{$opp->has_owner->name}}"  class="form-control @error('name') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="test" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge ">
                          <input type="text"  name="name" value="{{$opp->name}}"  class="form-control @error('name') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="test" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" name="size" value="{{$opp->size}}" min="0" id="size_input" class="form-control wb @error('size') is-invalid @enderror " placeholder="UBMRELLA.SA" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        </div>
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <span id="basic-icon-default-company2" class="input-group-text">SAR</span>
                          <input type="text" name="cost" onkeyup="costError()" value="{{$opp->cost}}" min="0" id="cost_input" class="form-control wb @error('cost') is-invalid @enderror " placeholder="UBMRELLA.SA" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        </div>
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="date" name="closing_date" value="{{$opp->closing_date}}" id="basic-icon-default-email" class="form-control @error('closing_date') is-invalid @enderror" placeholder="ORGANIZATION INDUSTRY" aria-label="john.doe" aria-describedby="basic-icon-default-email2" />
