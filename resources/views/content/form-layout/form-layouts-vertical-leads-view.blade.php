...
<style type="text/css">
    ...
    />
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Leads/</span>View Lead Info</h4>

<!-- Basic Layout -->
<div class="card container" style="width:80%"> 
  <form action="{{@route('lead.update' , $lead->id)}}" method="POST" enctype="multipart/form-data" id="target">
                @csrf 
                  ...
                  <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge ">
                          ...
                          <input type="text"  name="name" value="{{$lead->name}}" class="form-control @error('name') is-invalid @enderror " id="basic-icon-default-fullname" placeholder="test" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="number" name="size" min="0" id="basic-icon-default-company" value="{{$lead->size}}" class="form-control wb @error('size') is-invalid @enderror " placeholder="UBMRELLA.SA" aria-label="ACME Inc." aria-describedby="basic-icon-default-company2" />
                        </div>
                        @error('size')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          ...
                          <input type="date" name="closing_date" id="entrega" value="{{date('Y-m-d',strtotime($lead->closing_date))}}"  min="2018-01-01" max="2025-12-31" class="form-control flatpickr flatpickr-input active  @error('closing_date') is-invalid @enderror" placeholder="ORGANIZATION INDUSTRY" aria-label="john.doe" aria-describedby="basic-icon-default-email2"  />
