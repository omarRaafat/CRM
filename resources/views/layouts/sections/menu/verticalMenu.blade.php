<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    <a href="{{url('/')}}" class="app-brand-link">
      ...
      <img src="{{asset('assets/img/bu_crm_logo.png')}}" style="" width="195px" alt="LOGO" class="rounded">
      </span>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{$activeClass}}">
     ...
     @elseif(auth::user()->user_has_role->name == "Marketing-Manager" )

     @if($menu->name == "OPPs" || $menu->name == "Clients" || $menu->name == "Contacts" || $menu->name == "Leads")
